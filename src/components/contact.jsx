  ...
  return (
    <main className='contact_main main'>
      <div
        ...
        style={{
          background: `linear-gradient(to right, hsla(0, 0%, 0%, 0.6), hsla(38, 89%, 49%, 0.2)), url(${store})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', backgroundRepeat: 'no-repeat'
        }}
      />
      <p>
        Email:&nbsp;
