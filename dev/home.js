  ...
  #initializeDeleteItemPopUp() {
    ...
    >
      ...
      <div class="pop_up_buttons">
        <button id="${this.popUpCancelButtonId
      }" class="cancel_button">Cancel</button>
        <button id="${this.popUpDeleteButtonId
      }" class="delete_button" onclick="${this.#deleteProductFunction
      }(event)">Delete</button>
      </div>
    </div>`
      ...
      return `<li class="item" id="${_id}">
        ...
        // </span>`
                       ...
                       <img
                        ...
                        data-id="${_id}"
                        data-name="${name}"
                        onclick="${self.displayPopUpFunction}(event, ${self.popUpId
...
class AdminForm extends Page {
  ...
  initialize() {
    ...
    adminForm.outerHTML = `<form id="${this.formId}" class="admin_form" hidden>
        <button type="button" onclick="${this.hideFunctionName
      }(event)">Close</button>
        ...
        <label>
          Category:<br />
          <select class="form_input" name="category" id="${this.categoryOptions
      }" required>
        ...
        <fieldset class="price_fieldset">
          ...
          <label>
            <input type="radio" name="price_option" value="single_price" id="${this.singlePriceOptionId
      }" class="price_option" onclick="${this.switchPriceMethodName
      }(event)" checked /> Single
          </label>
          <label>
            <input type="radio" name="price_option" value="multiple_prices" id="${this.multiplePriceOptionId
      }" class="price_option" onclick="${this.switchPriceMethodName
      }(event)"/> Multiple
          </label>
          <hr />
          <label>
            Price:<br />
            <input type="number" name="price" class="single_price" id="${this.singlePriceInputId
      }" step="0.01" min="0.01" placeholder="$4.99" required />
          </label>
          <fieldset class="quantity_prices_fieldset" id="${this.quantitiesFieldsetId
      }" disabled>
            ...
            <button class="add_quantity_button" type="button" onclick="${this.addQuantityPriceMethodName
